...
_smoke() {
  ...
  for pd in "$pd1" "$pd2"; do
    for f in build_shot.png build_shot2.png build_shot3.png build_boat.png build_heli.png build_plane.png build_service.png build_pause.png build_settings.png build_chase.png build_rain.png build_night.png build_race.png build_activity.png build_fail.png; do
